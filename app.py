...
# ✅ Respuestas clínicas manuales corregidas por el Lic. Bustamante
respuestas_personalizadas = {
    1: "Hola, ¿qué tal? Se observa una vivencia de falta de sentido. ¿Hay algún otro malestar que adviertas o puedas mencionar?",
    ...
    4: "Podría tratarse de un estado de autovaloración negativa, con pensamientos autorreferenciales que refieren a carga o inutilidad. ¿Te ocurre con frecuencia o en situaciones específicas?",
    5: "Con base en lo que has descripto —aislamiento, desgano, desesperanza—, pareciera tratarse de un estado emocional predominantemente Depresivo. ¿Te interesaría consultarlo con el Lic. Daniel O. Bustamante? Podés escribirle al WhatsApp +54 911 3310-1186 para una evaluación más detallada.",
    6: "Da la sensación de episodios de llanto incontrolable que podrían tener un origen emocional profundo. ¿Recordás si aparecen en momentos particulares o sin motivo aparente?",
    7: "Normalmente se trata de una dificultad en el sostenimiento atencional, posiblemente influida por factores emocionales o contextuales. ¿Este problema de concentración es reciente o persistente?",
    8: "Podría estar vinculada una autopercepción negativa generalizada. Esa idea de 'fracaso total' merece ser observada en función de tu historia y contexto. ¿Hay algún momento donde esto se haya acentuado?",
    9: "Por lo que comentás, pues al malestar anímico que describiste anteriormente, advierto que se suman aislamiento, dificultades atencionales, percepción de fracaso y evitación social, por lo que daría la impresión de que se trata de un estado emocional predominantemente Depresivo. No obstante, para estar seguros se requiere de una evaluación psicológica profesional. Te sugiero escribirle al Lic. Daniel O. Bustamante al WhatsApp +54 911 3310-1186.",
    10: "He encontrado interesante nuestra conversación, pero para profundizar más en el análisis de tu malestar, sería ideal que consultes con un profesional. Por ello, te sugiero que te contactes con el Lic. Bustamante. Lamentablemente, no puedo continuar con la conversación más allá de este punto.",
    11: "Para seguir explorando lo que estás atravesando en profundidad, lo ideal es hacerlo con el Lic. Bustamante en un entorno clínico. Podés escribirle al WhatsApp +54 911 3310-1186 para una atención personalizada.",
    12: "Este espacio ya cumplió su función de orientación. Para una atención clínica sostenida, te recomiendo continuar el diálogo con el Lic. Bustamante. Podés escribirle al WhatsApp +54 911 3310-1186.",
